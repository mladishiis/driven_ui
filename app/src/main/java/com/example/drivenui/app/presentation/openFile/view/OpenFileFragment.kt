...
import com.example.drivenui.app.presentation.details.ui.DetailsFragment
...
import com.example.drivenui.app.presentation.openFile.vm.OpenFileViewModel
import com.example.drivenui.app.presentation.render.TestRenderFragment
        ...
        viewModel.effect.onEach { effect ->
            when (effect) {
                ...
                is OpenFileEffect.NavigateToTestScreen -> {
                    NavigationManager.setMappedDataForNextScreen(effect.mappedData)
